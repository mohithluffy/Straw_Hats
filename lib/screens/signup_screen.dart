              ...
              children: <Widget>[
                ...
                firebaseUIButton(context, "Sign Up", () {
                  triggerNotification(){
                    AwesomeNotifications().createNotification(
                      content: NotificationContent(id: 10,
                        ...
                        body: 'verify link has been sent to your email ',
                      ),
                    );
                  }
                  ...
                  FirebaseAuth.instance
                    ...
                    else if(error.toString() == "[firebase_auth/unknown] Given String is empty or null") showError2();
                    else if(error.toString() == "[firebase_auth/weak-password] Password should be at least 6 characters") showError();
                    else showError4();
